...
extension WishlistItemQueryFilter
  ...
  QueryBuilder<WishlistItem, WishlistItem, QAfterFilterCondition> nameLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<WishlistItem, WishlistItem, QAfterFilterCondition> nameBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<WishlistItem, WishlistItem, QAfterFilterCondition> nameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WishlistItem, WishlistItem, QAfterFilterCondition> nameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WishlistItem, WishlistItem, QAfterFilterCondition> nameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension WishlistItemQuerySortBy
  ...
  QueryBuilder<WishlistItem, WishlistItem, QAfterSortBy> sortByEstimatedCost() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WishlistItem, WishlistItem, QAfterSortBy> sortByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }

  QueryBuilder<WishlistItem, WishlistItem, QAfterSortBy> sortBySortOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortOrder', Sort.asc);
    });
  }

  QueryBuilder<WishlistItem, WishlistItem, QAfterSortBy> sortBySortOrderDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension WishlistItemQuerySortThenBy
  ...
  QueryBuilder<WishlistItem, WishlistItem, QAfterSortBy> thenByEstimatedCost() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'estimatedCost', Sort.asc);
    });
  }
  ...
  QueryBuilder<WishlistItem, WishlistItem, QAfterSortBy> thenByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }

  QueryBuilder<WishlistItem, WishlistItem, QAfterSortBy> thenBySortOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortOrder', Sort.asc);
    });
  }

  QueryBuilder<WishlistItem, WishlistItem, QAfterSortBy> thenBySortOrderDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sortOrder', Sort.desc);
    });
  }
...
extension WishlistItemQueryWhereDistinct
  ...
  QueryBuilder<WishlistItem, WishlistItem, QDistinct> distinctBySortOrder() {
    return QueryBuilder.apply(this, (query) {
...
extension WishlistItemQueryProperty
  ...
  QueryBuilder<WishlistItem, String, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'name');
    });
  }

  QueryBuilder<WishlistItem, int, QQueryOperations> sortOrderProperty() {
    return QueryBuilder.apply(this, (query) {
